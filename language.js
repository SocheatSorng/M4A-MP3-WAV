(() => {
  const translations = {
    ...
    kh: {
      ...
      selectAudioFilesFromFiles: 'នៅក្នុង Voice Memos សូមចុច Share > Save to Files បន្ទាប់មកជ្រើសឯកសារ M4A ឬ MP3 នៅទីនេះ។',
      iosGuideLabel: 'មគ្គុទ្ទេសក៍ IPHONE',
      iosGuideTitle: 'ផ្ទេរការថតសំឡេង Voice Memos ទៅ Files',
      iosGuideText: 'នៅក្នុង Voice Memos សូមជ្រើសការថតសំឡេង ចុច Share ជ្រើស Save to Files ហើយរក្សាទុកក្នុងថតដែលអ្នកអាចរកឃើញម្តងទៀត។',
