(() => {
  const translations = {
    en: {
      ...
      files: 'files',
      file: 'file',
      dropPrompt: 'or choose files or a parent folder',
      ...
      chooseAudio: 'Choose M4A or MP3 files',
      ...
      tooLarge: 'is larger than the 500 MB limit.', chooseSupported: 'Please choose M4A or MP3 files.', unableFolder: 'Unable to read that folder.',
    ...
    kh: {
      ...
      chooseAudio: 'ជ្រើសឯកសារ M4A ឬ MP3',
      ...
      tooLarge: 'ធំជាងកំណត់ ៥០០ MB។', chooseSupported: 'សូមជ្រើសឯកសារ M4A ឬ MP3។', unableFolder: 'មិនអាចអានថតនោះបានទេ។',
